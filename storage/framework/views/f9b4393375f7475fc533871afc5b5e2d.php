...
unset($__errorArgs, $__bag); ?>
                        ...
                        <textarea value="<?php echo e(old('markings')); ?>" required name="markings" id="markings" class="body-content form-control" type="text" style="width:500px; height:200px;"><?php echo e(old('markings')); ?></textarea>
                    </div>
                </div>
            </div>
...
<?php endif; ?><?php /**PATH /Users/rob/Desktop/TSU_SAM/resources/views/post-item.blade.php ENDPATH**/ ?>