...
<?php $component->withAttributes([]); ?>
    ...
    <div class="container py-md-5">
        ...
        <div class="row">
            <div class="col-md-6">
                <p><strong>Found Date:</strong> <?php echo e($item->lost_date); ?></p>
                <p><strong>Category:</strong> <?php echo e($item->category); ?></p>
                <p><strong>Location:</strong> <?php echo e($item->location); ?></p>
                <p style="margin-bottom: 4px;"><strong>Claimed By:</strong> <?php echo e($item->claimed_by); ?></p>
                <?php if(
                      $item->status !== 'Claimed' &&
            ...
            <div class="col-md-6">
                ...
                <p><strong>Storage Bin:</strong> <?php echo e($item->bin); ?></p>
        ...
        <div class="body-content">
            <p><strong>Markings:</strong> <textarea readonly class="form-control mb-2" rows="3" readonly style="height: 50px; width: 100%; overflow-y: auto; background-color: #e2e8f0; border: none; resize: none; padding: 5px; border-radius: 5px;"><?php echo e($item->markings); ?></textarea></p>
...
<?php endif; ?><?php /**PATH C:\Users\alyza\FINAL_LNF\FINAL_LNF\resources\views/single-item.blade.php ENDPATH**/ ?>