    ...
    <div class="container py-md-5">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <p><strong>Claimed By:</strong> <?php echo e($item->claimed_by); ?></p>  
                <?php if($item->status !== 'To Be Claimed' && $item->status !== 'Claimed' && $item->status !== 'Disposed'): ?>
                <form action="<?php echo e(route('item.claim', $item->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <button type="submit" class="btn btn-success btn-sm mt-2">Claim</button>
              </form>
            <?php endif; ?>
...
<?php endif; ?><?php /**PATH /Users/rob/Desktop/TSU_SAM/resources/views/single-item.blade.php ENDPATH**/ ?>