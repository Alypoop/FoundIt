            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    <?php $__currentLoopData = $histories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $history): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><?php if($history->item): ?>
                            <a href="<?php echo e(url('/item/' . $history->item->id)); ?>"><?php echo e($history->item->title); ?></a>
                            <?php else: ?>
                                Unknown
                            <?php endif; ?>
                            </td>
                            <td><?php echo e($history->item->location ?? 'Unknown'); ?></td>
...
<?php endif; ?><?php /**PATH C:\Users\alyza\FINAL_LNF\FINAL_LNF\resources\views/all-history.blade.php ENDPATH**/ ?>