                    ...
                    <div class="card w-100 shadow-sm">
                        <div class="card-body d-flex flex-column">
                            ...
                            <h6 class="card-subtitle mb-2 text-muted text-center">
                                ...
                                &nbsp;<a href="/profile/<?php echo e($item->user->username); ?>"><?php echo e($item->user->username); ?></a>
                            </h6>

                            <p class="text-muted small text-center mb-1">Date Found: <?php echo e($item->lost_date->format('M j, Y')); ?></p>
                            <p class="text-muted small text-center mb-2">
                                Category: <?php echo e($item->category->name); ?>

                                <?php if($item->itemType): ?>
                                    <br>Type: <?php echo e($item->itemType->name); ?>
...
<?php endif; ?><?php /**PATH D:\FoundItSystem\FoundIt\resources\views/homepage-feed.blade.php ENDPATH**/ ?>