...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <select  id="category" name="category" class="form-control" value="">
                            ...
                            <option value="Make-up Essentials" <?php echo e(old('category', $item->location) == 'Make-up Essentials' ? 'selected' : ''); ?>>Make-up Essentials</option>
                            <option value="Electronic Devices" <?php echo e(old('category', $item->location) == 'Electronic Devices' ? 'selected' : ''); ?>>Electronic Devices</option>
...
<?php endif; ?><?php /**PATH C:\Users\alyza\FINAL_LNF\FINAL_LNF\resources\views/edit-item.blade.php ENDPATH**/ ?>