...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                        <label for="loc_seen" class="form-label">Place last seen:</label>
                         <?php $__errorArgs = ['loc_seen'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        <input value="<?php echo e(old('loc_seen' , $item->loc_seen)); ?>" required type="text" id="loc_seen" name="loc_seen" class="form-control" placeholder="Enter place">
                    </div>
                </div>
...
<?php endif; ?><?php /**PATH /Users/rob/TSU_SAM/resources/views/edit-item.blade.php ENDPATH**/ ?>